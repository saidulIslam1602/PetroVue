...
import { MetricCardContainer, MetricHeader, MetricValue, MetricChange, MetricIcon } from './MetricCard.styles';
...
export const MetricCard: React.FC<MetricCardProps> = ({
  ...
  return (
    <MetricCardContainer status={status} className={className} data-testid={testId}>
      <MetricHeader>
      ...
      {change && (
        <MetricChange type={change.type}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
            {getTrendIcon(change.type === 'increase' ? 'up' : change.type === 'decrease' ? 'down' : 'stable')}
