...
import {
  ...
  EnvironmentalGrid,
  ComplianceGrid,
} from './EnvironmentalMonitor.styles';
          ...
          <ComplianceGrid>
            <div
              style={{
                padding: '1rem',
                backgroundColor:
                  getComplianceColor(metrics.compliance.airQuality) ===
                  '#059669'
                    ? '#f0fdf4'
                    : getComplianceColor(metrics.compliance.airQuality) ===
                        '#d97706'
            ...
            <div
              style={{
                padding: '1rem',
                backgroundColor:
                  getComplianceColor(metrics.compliance.waterQuality) ===
                  '#059669'
                    ? '#f0fdf4'
                    : getComplianceColor(metrics.compliance.waterQuality) ===
                        '#d97706'
            ...
            <div
              style={{
                padding: '1rem',
                backgroundColor:
                  getComplianceColor(metrics.compliance.wasteManagement) ===
                  '#059669'
                    ? '#f0fdf4'
                    : getComplianceColor(metrics.compliance.wasteManagement) ===
                        '#d97706'
            ...
            <div
              style={{
                padding: '1rem',
                backgroundColor:
                  getComplianceColor(metrics.compliance.overall) === '#059669'
                    ? '#f0fdf4'
                    : getComplianceColor(metrics.compliance.overall) ===
                        '#d97706'
                      ? '#fffbeb'
                      : '#fef2f2',
                borderRadius: '6px',
