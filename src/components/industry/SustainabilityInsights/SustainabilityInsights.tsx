  ...
  insights: [
    {
      ...
      description:
        'CO₂ emissions decreased by 12% compared to last quarter through electrification initiatives',
      impact: 'high',
      metric: '-12% QoQ',
      trend: 'improving',
    },
    {
      ...
      description:
        'Offshore wind integration surpassing targets, contributing to 42% renewable energy mix',
      impact: 'high',
      metric: '+8% vs target',
      trend: 'improving',
    },
    {
      ...
      description:
        'New water treatment systems increased recycling rate from 68% to 78%',
      impact: 'medium',
    ...
    },
    {
      ...
      description:
        'Analysis shows 15% of operational waste could be diverted to recycling streams',
      impact: 'medium',
      metric: '15% potential',
      trend: 'stable',
    },
  ...
  recommendations: [
    {
      ...
      description:
        'Install heat recovery systems on gas turbines to reduce fuel consumption by 8-10%',
      priority: 'high',
    ...
    },
    {
      ...
      description:
        'Increase solar capacity on offshore platforms to supplement power generation',
      priority: 'medium',
    ...
    },
    {
      ...
      description:
        'Replace all remaining traditional lighting with LED systems across facilities',
      priority: 'low',
  ...
  achievements: [
    {
      ...
      description:
        'Achieved zero routine flaring across all Norwegian Continental Shelf operations',
      date: '2024-11',
      category: 'Emissions',
    },
    {
      ...
      description:
        'Successfully renewed ISO 14001 Environmental Management certification',
      date: '2024-10',
      category: 'Compliance',
    },
    {
      ...
      description:
        'Reached 1 million working hours without environmental incidents',
      date: '2024-09',
      category: 'Safety',
    },
  ],
              ...
              <MetricBox>
                ...
                >
                  <Typography variant='caption' color='text.secondary'>
                    {data.carbonReduction.current.toLocaleString()} /{' '}
                    {data.carbonReduction.target.toLocaleString()} tonnes CO₂e
                  </Typography>
                  <Chip
                    icon={<TrendingDown />}
                    label='On Track'
            ...
            <Grid item xs={12} sm={6}>
              <MetricBox>
                ...
                >
                  ...
                  <Chip label='Near Target' color='info' size='small' />
                </Box>
              </MetricBox>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <MetricBox>
                ...
                >
                  ...
                  <Chip label='Improving' color='secondary' size='small' />
                </Box>
              </MetricBox>
            </Grid>
          </Grid>
              ...
              <CardContent>
                ...
                >
                  <Box sx={{ display: 'flex', gap: 2, alignItems: 'start' }}>
                    <Avatar
                      sx={{
                        bgcolor: `${insight.trend === 'improving' ? 'success' : 'warning'}.light`,
                      }}
                    >
                ...
                <Box sx={{ display: 'flex', gap: 1, mt: 2 }}>
                  <Chip
                    ...
                    color={
                      insight.trend === 'improving' ? 'success' : 'warning'
                    }
                    size='small'
                  />
                  <Chip
