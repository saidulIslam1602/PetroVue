    ...
    formations: [
      {
        ...
        shows: {
          ...
          gasShows: false,
          waterShows: true,
          description: 'Water bearing sands',
        },
      ...
      },
      {
        ...
        shows: {
          ...
          gasShows: true,
          waterShows: false,
          description: 'Source rock with hydrocarbon shows',
        },
      ...
      },
      {
        ...
        shows: {
          ...
          gasShows: false,
          waterShows: false,
          description: 'Primary reservoir with oil shows',
        },
...
export const DrillingOperationsTracker: React.FC = () => {
  ...
  const calculateProgress = (operation: DrillingOperation): number => {
    return (
      (operation.wellDesign.currentDepth / operation.wellDesign.plannedDepth) *
      100
    );
  };
  ...
  const getDaysRemaining = (operation: DrillingOperation): number => {
    return Math.ceil(
      (operation.timeline.estimatedCompletion.getTime() - Date.now()) /
        (1000 * 60 * 60 * 24)
    );
  };
  ...
  const getCurrentSection = (
    ...
    return operation.wellDesign.sections.find(
      section =>
  ...
  return (
    <Container maxWidth='xl' sx={{ py: 4 }}>
      ...
      <Typography variant='subtitle1' sx={{ mb: 4, color: 'text.secondary' }}>
        {norwegianTranslations.realTime} overvåking av boreoperasjoner på norsk
        kontinentalsokkel
      </Typography>
      ...
      >
        <DrillingCard>
          <CardContent>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
              ...
              <Typography variant='h6'>Aktiv Boring</Typography>
            </Box>
            <Typography variant='h4' sx={{ fontWeight: 'bold', mb: 1 }}>
              {selectedOperation.wellDesign.currentDepth.toLocaleString(
                'nb-NO'
              )}
            </Typography>
            <Typography variant='body2' sx={{ opacity: 0.9 }}>
              av{' '}
              {selectedOperation.wellDesign.plannedDepth.toLocaleString(
                'nb-NO'
              )}{' '}
              m MD
            </Typography>
        ...
        <MudCard>
          <CardContent>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
              <Speed sx={{ mr: 1 }} />
              <Typography variant='h6'>Penetrasjonsrate</Typography>
            </Box>
            <Typography variant='h4' sx={{ fontWeight: 'bold', mb: 1 }}>
        ...
        <FormationCard>
          <CardContent>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
              <Layers sx={{ mr: 1 }} />
              <Typography variant='h6'>Formasjon</Typography>
            </Box>
            <Typography variant='h4' sx={{ fontWeight: 'bold', mb: 1 }}>
        ...
        <PerformanceCard>
          <CardContent>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
              <TrendingUp sx={{ mr: 1 }} />
              <Typography variant='h6'>Fremdrift</Typography>
            </Box>
            <Typography variant='h4' sx={{ fontWeight: 'bold', mb: 1 }}>
          ...
          >
            <Box>
              ...
              <Typography variant='body1' color='text.secondary'>
                Rigg: {selectedOperation.rigName} • Blokk:{' '}
                {selectedOperation.location.block} • Felt:{' '}
                {selectedOperation.location.field}
              </Typography>
              <Typography variant='body2' color='text.secondary'>
                Vanndyp: {selectedOperation.location.waterDepth} m •
                Koordinater:{' '}
                {selectedOperation.location.coordinates.latitude.toFixed(4)}°N,{' '}
                {selectedOperation.location.coordinates.longitude.toFixed(4)}°E
              </Typography>
            </Box>
          ...
          >
            <Paper sx={{ p: 2 }}>
              ...
              <Typography variant='body1' sx={{ fontWeight: 'bold' }}>
                {selectedOperation.timeline.spudDate.toLocaleDateString(
                  'nb-NO'
                )}
              </Typography>
            </Paper>
            <Paper sx={{ p: 2 }}>
              ...
              <Typography variant='body1' sx={{ fontWeight: 'bold' }}>
                {selectedOperation.timeline.estimatedCompletion.toLocaleDateString(
                  'nb-NO'
                )}
              </Typography>
            </Paper>
            <Paper sx={{ p: 2 }}>
              ...
              <Typography variant='body1' sx={{ fontWeight: 'bold' }}>
                {(selectedOperation.costs.currentCost / 1000000).toFixed(1)}M
                NOK
              </Typography>
              <Typography variant='caption'>
                av {(selectedOperation.costs.totalBudget / 1000000).toFixed(0)}M
                NOK
              </Typography>
            </Paper>
            <Paper sx={{ p: 2 }}>
          ...
          >
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell align='right'>
                      {selectedOperation.drillingParameters.currentDepth.toLocaleString(
                        'nb-NO'
                      )}
                    </TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell align='right'>
                      {selectedOperation.drillingParameters.hookLoad}
                    </TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell align='right'>
                      {selectedOperation.drillingParameters.weightOnBit}
                    </TableCell>
                    <TableCell>tonn</TableCell>
                  </TableRow>
                  <TableRow>
                    ...
                    <TableCell align='right'>
                      {selectedOperation.drillingParameters.rotarySpeed}
                    </TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell align='right'>
                      {selectedOperation.drillingParameters.torque}
                    </TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell align='right'>
                      {selectedOperation.drillingParameters.standpipePressure}
                    </TableCell>
            ...
            <TableContainer component={Paper}>
              <Table size='small'>
                ...
                <TableBody>
                  {selectedOperation.wellDesign.sections.map(
                    (section, index) => (
                      <TableRow key={index}>
                  ...
                  <Table size='small'>
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell align='right'>
                          {selectedOperation.mudLogging.hydrocarbon.c1}%
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>C2 (Etan)</TableCell>
                        <TableCell align='right'>
                          {selectedOperation.mudLogging.hydrocarbon.c2}%
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>C3 (Propan)</TableCell>
                        <TableCell align='right'>
                          {selectedOperation.mudLogging.hydrocarbon.c3}%
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>C4 (Butan)</TableCell>
                        <TableCell align='right'>
                          {selectedOperation.mudLogging.hydrocarbon.c4}%
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>C5+ (Tyngre)</TableCell>
                        <TableCell align='right'>
                          {selectedOperation.mudLogging.hydrocarbon.c5plus}%
                        </TableCell>
                      </TableRow>
                  ...
                  <Table size='small'>
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell align='right'>
                          {selectedOperation.mudLogging.mudProperties.density}{' '}
                          SG
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        ...
                        <TableCell align='right'>
                          {selectedOperation.mudLogging.mudProperties.viscosity}{' '}
                          cP
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        ...
                        <TableCell align='right'>
                          {selectedOperation.mudLogging.mudProperties.fluidLoss}{' '}
                          ml/30min
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        ...
                        <TableCell align='right'>
                          {selectedOperation.mudLogging.mudProperties.ph}
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        ...
                        <TableCell align='right'>
                          {
                            selectedOperation.mudLogging.mudProperties
                              .temperature
                          }
                          °C
                        </TableCell>
              ...
              <CardContent>
                  ...
                  <Table size='small'>
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell>
                          {selectedOperation.mudLogging.cuttings.lithology}
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        <TableCell>Porøsitet</TableCell>
                        <TableCell>
                          {selectedOperation.mudLogging.cuttings.porosity}
                        </TableCell>
                      </TableRow>
                      <TableRow>
                        ...
                        <TableCell>
                          <Chip
                            label={
                              selectedOperation.mudLogging.cuttings.oilStaining
                            }
                            color={
                              selectedOperation.mudLogging.cuttings
                                .oilStaining === 'good'
                                ? 'success'
                                : 'default'
                            }
                      ...
                      <TableRow>
                        ...
                        <TableCell>
                          <Chip
                            label={
                              selectedOperation.mudLogging.cuttings.fluorescence
                            }
                            color={
                              selectedOperation.mudLogging.cuttings
                                .fluorescence === 'bright'
                ...
                <Alert severity='info' sx={{ mt: 2 }}>
                  <Typography variant='body2'>
                    <strong>Gass Enheter:</strong>{' '}
                    {selectedOperation.mudLogging.gasUnits} enheter
                  </Typography>
                  <Typography variant='body2'>
                    <strong>Nåværende ROP:</strong>{' '}
                    {selectedOperation.mudLogging.rop} m/h
                  </Typography>
                </Alert>
              </CardContent>
            </Card>
                  ...
                  <TableRow key={index}>
                    ...
                    <TableCell>
                      <Box sx={{ display: 'flex', gap: 0.5, flexWrap: 'wrap' }}>
                        {formation.shows.oilShows && (
                          <Chip label='Olje' color='success' size='small' />
                        )}
                        {formation.shows.gasShows && (
                          <Chip label='Gass' color='warning' size='small' />
                        )}
                        {formation.shows.waterShows && (
                          <Chip label='Vann' color='info' size='small' />
                        )}
                      </Box>
                    </TableCell>
                  </TableRow>
          ...
          >
            <Card>
              <CardContent>
                ...
                >
                  {(
                    selectedOperation.bitPerformance.reduce(
                      (sum, bit) => sum + bit.rop,
                      0
                    ) / selectedOperation.bitPerformance.length
                  ).toFixed(1)}
                </Typography>
